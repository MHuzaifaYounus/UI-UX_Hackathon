    ...
    return (
        <div>
            <div className="hero w-full h-[320px] menu_bg flex flex-col items-center justify-center ">
                <h1 className='pb-5 font-bold text-5xl text-white'>Blog Details</h1>
                <Breadcrumb>
                    <BreadcrumbList>
                        <BreadcrumbItem >
                        ...
                        <BreadcrumbItem className='text-white'>
                            <BreadcrumbLink href="/blog">Blog Details</BreadcrumbLink>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
                ...
                <div className=" p-4 max-sm:p-0">
                    <div className="w-[80%] mx-auto max-sm:w-full">
                        ...
                        <div className="relative">
                            <Image
                                src={`/img/blog${Number(params?.blogId) + 1}.svg`}
                                alt="no img found"
                                height={520}
                                width={872}
